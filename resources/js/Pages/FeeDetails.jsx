            ...
            <div className="student-profile-container">
                ...
                <div className="profile-header">
                    ...
                    <div className="profile-tabs">
                        ...
                        >
                            <Split size={18} /> Internal Ledger Splits
                        </button>
                        <button
                    ...
                    {activeTab === 'beneficiaries' && (
                        <div className="content-card">
                            <div className="card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <div>
                                    <h3>Internal Settlement Splits</h3>
                                    <p>Configure how revenue is distributed for daily payouts.</p>
                                </div>
                                <button className="secondary-btn" onClick={() => setShowBeneficiaryModal(true)}>
                                    <Edit size={16} style={{ marginRight: '6px' }} /> Configure Splits
                                </button>
                            </div>
                                ...
                                <div className="accounts-list">
                                    {fee.beneficiaries.map((ben, idx) => (
                                        <div key={idx} className="account-item">
                                            <div className="bank-logo" style={{ fontSize: '0.8rem', width: 'auto', padding: '0 12px', height: '40px', borderRadius: '20px' }}>
                                                ₦{ben.amount ? new Intl.NumberFormat().format(ben.amount) : '0'}
                                            </div>
